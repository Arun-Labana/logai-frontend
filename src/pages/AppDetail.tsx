      ...
      <div className="bg-logai-bg-card border border-logai-border rounded-xl overflow-hidden mb-8">
        ...
        {clusters.length === 0 ? (
          <div className="p-12 text-center">
            ...
            <div className="bg-logai-bg-secondary rounded-lg p-4 mb-4 text-left max-w-md mx-auto">
              <p className="text-xs text-logai-text-secondary mb-2">
                💡 <strong>Tip:</strong> Make sure your Java app is configured with this app's ID:
              </p>
